    ...
    for i = 1, MERCHANT_ITEMS_PER_PAGE, 1 do
        ...
        if (isBuyBack) then
            ...
            if ((i % EXTVENDOR_ITEMS_PER_SUBPAGE) == 1) then
                if (i == 1) then
                    btn:SetPoint("TOPLEFT", MerchantFrame, "TOPLEFT", 34, -70);
                else
...
function ExtVendor_RebuildMerchantFrame()
    ...
    local topmiddleleft = MerchantFrame:CreateTexture(nil, "BACKGROUND");
    topmiddleleft:SetPoint("TOP", MerchantFrame, "TOP", 0, 10);
    topmiddleleft:SetTexture("Interface\\AddOns\\ExtVendor\\textures\\UI-Merchant-TopLeftwide");

    local botmiddleleft = MerchantFrame:CreateTexture(nil, "BACKGROUND");
    botmiddleleft:SetPoint("BOTTOM", MerchantFrame, "BOTTOM", 0, 20);
    ...
    MerchantBuyBackItem:SetPoint("TOPLEFT", MerchantItem10, "BOTTOMLEFT", -23.5, -20);

    -- move the next/previous page buttons
    MerchantPrevPageButton:ClearAllPoints();
    MerchantPrevPageButton:SetPoint("CENTER", MerchantFrame, "BOTTOM", 30, 50);
    MerchantPageText:ClearAllPoints();
    MerchantPageText:SetPoint("BOTTOM", MerchantFrame, "BOTTOM", 160, 50);
    MerchantNextPageButton:ClearAllPoints();
    MerchantNextPageButton:SetPoint("CENTER", MerchantFrame, "BOTTOM", 290, 50);
    -- currency insets
    ...
    editbox:SetPoint("TOPRIGHT", MerchantFrame, "TOPRIGHT", -55, -32);
    ...
    junkBtn:SetPoint("TOPLEFT", MerchantFrame, "TOPLEFT", 80, -28);
   ...
   local filterBtn = CreateFrame("Button", "MerchantFrameFilterButton", MerchantFrame, "ExtVendor_UIButtonStretchTemplate");
    ...
    hiddenText:SetText("0 предмет(ов) спрятано");
